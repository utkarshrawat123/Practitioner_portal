...
- **State:** **494 tests pass · production build clean · runs fully in MOCK MODE with no API keys.**
...
```bash
npm install
npm test            # Vitest — 494 tests, keep green
...
- **Tests:** `npm test` — 494 tests. Harness: `beforeEach` sets `process.env.DB_PATH` to a temp file;
