...
- **State:** **477 tests pass · production build clean · runs fully in MOCK MODE with no API keys.**
...
```bash
npm install
npm test            # Vitest — 477 tests, keep green
...
- **Tests:** `npm test` — 477 tests. Harness: `beforeEach` sets `process.env.DB_PATH` to a temp file;
